...
export const metadata = { title: "حساب برو" };
  ...
  return (
    <div className="container-page py-12 pb-16 space-y-10">
      <div className="text-center space-y-3">
        ...
        <h1 className="font-display font-extrabold text-3xl sm:text-4xl">حساب برو للتجار</h1>
      ...
      <div className="grid md:grid-cols-3 gap-5 max-w-4xl mx-auto items-stretch">
        {plans.map((plan) => {
          ...
          if (isCurrent) {
            ...
            ctaLabel = isFree ? "ابدأ مجاناً" : "أنشئ حساباً للاشتراك";
            ctaHref = "/register";
          } else {
            ctaLabel = isFree ? "الرجوع للمجاني" : "اشترك الآن";
            ctaHref = "/dashboard";
          }
      ...
      <p className="text-center text-xs text-neutral-400 max-w-lg mx-auto">
        بوابة الدفع (Moyasar / Tap) قيد الربط — الاشتراكات ستتاح مع الإطلاق الرسمي.
        حراج ستيشن لا تفرض أي عمولة على معاملات البيع بين المستخدمين.
      </p>
      <p className="text-center text-xs text-neutral-400 max-w-lg mx-auto">
