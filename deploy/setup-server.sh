...
echo "==> directories"
mkdir -p "$APP_DIR" /var/www/harajstation-releases /var/www/harajstation-run "$LOG_DIR" /var/backups/harajstation /var/lib/haraj-backup
chown -R haraj:haraj "$APP_DIR" /var/www/harajstation-releases /var/www/harajstation-run "$LOG_DIR" /var/backups/harajstation /var/lib/haraj-backup
